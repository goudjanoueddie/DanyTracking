...
@NamedQueries({
    ...
    , @NamedQuery(name="TaskLog.findTaskLogCountByTask",query="SELECT count(tl) FROM TaskLog tl WHERE tl.user= :user")
...
public class TaskLog extends AbstractEntity implements EntityItem<Integer> {
    ...
    public String toString() {
        return "com.jdeveloper.tttracker.domain.TaskLog[ idTaskLog=" + idTaskLog + " ]";
    }
    ...
    public void addJson(JsonObjectBuilder builder) {
        ...
        builder.add("idTaskLog", idTaskLog)
               ...
               .add("taskLogDate", taskLogDate == null?"":DATE_FORMAT_yyyyMMdd.format(taskLogDate)).add("taskMinutes", taskMinutes);
